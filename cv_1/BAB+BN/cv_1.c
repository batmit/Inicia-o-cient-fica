...
int main(){
    ...
    double melhorCusto = heuristicaBN(vetorCidades, matrizDistancia, resultadoFinal);
...
double heuristicaBN(Cidade *vetorCidades, double **matrizDistancia, int *resultadoFinal){
    ...
    while(cont < CIDADES -1){
        ...
        for(int j = 1; j < CIDADES; j++){
            ...
            if(vetorCidades[j].visitado == 0){
            
                if(matrizDistancia[resultadoFinal[0]][j] < menorDist){

                    menorDist = matrizDistancia[resultadoFinal[0]][j];
                    cidade = j;
                }
        ...
        if(nivel >= 1){
            ...
            for(int j =1; j < CIDADES; j++){
                ...
                if( vetorCidades[j].visitado == 0){
                    ...
                    if(matrizDistancia[resultadoFinal[nivel]][j] < menorDist){

                        menorDist = matrizDistancia[resultadoFinal[nivel]][j];
                        cidade = j;
                        extremo = 1;
                    }
        ...
        if(extremo == 1 || nivel == 0){

            nivel++;
            resultadoFinal[nivel] = cidade;
        }else{
            empurrarVet(resultadoFinal, nivel);
            resultadoFinal[0] = cidade;
            nivel++;
        }
    ...
    soma += matrizDistancia[resultadoFinal[nivel]][resultadoFinal[0]];
    return soma;
}
